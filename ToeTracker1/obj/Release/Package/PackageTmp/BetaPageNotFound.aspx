<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BetaPageNotFound.aspx.cs" Inherits="ToeTracker1.BetaPageNotFound" %>
...
<div style="top: 0px; width: 100%; text-align: center; position: absolute;top:100px">
 The Product is under developement and been given access to only restricted users. Please email to <b>NewRegistration@ToeTracker.com </b> to get the early access. 
</div>
