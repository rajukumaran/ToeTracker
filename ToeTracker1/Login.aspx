...
<div style="top: 40px; width: 100%; text-align: center; position: absolute;">
<img src="bg2.png"/>
</div>
...
<div>
   ...
   <a href="/BetaPageNotFound.aspx" role="button" class="btn btn-primary btn-large" data-toggle="modal-popover" data-placement="bottom" style="float: right; padding: 4px;position: absolute;top: 6px;right: 10px;font-size:12px;font-weight:bold" >Register</a> 
   </b></h3>
   <div class="popover-content" style="background-color:rgb(121,129,219);color:#ffffff">
      <table cellpadding="3" cellspacing="3">
           ...
           <tr>
               ...
               <a href="/AuthFailed.aspx" role="button" class="btn btn-primary btn-large" data-toggle="modal-popover" data-placement="bottom" style="width:150px;text-align:center" >Sign In</a>
               </td>
           </tr>
       </table>
   </div>
    ...
    <div id="FindTrainer" class="popover" style="width: 230px;background-color:rgb(31, 37, 114)" >
       <div class="arrow" style="border-bottom-color: rgb(31, 37, 114)"></div>
   ...
   <a href="/BetaPageNotFound.aspx" role="button" class="btn btn-primary btn-large" data-toggle="modal-popover" data-placement="bottom" style="float: right; padding: 4px;position: absolute;top: 6px;right: 10px;font-size:12px;font-weight:bold" >More Options</a> 
   ...
   <div class="popover-content" style="background-color:rgb(121,129,219);color:#ffffff">
      <table cellpadding="3" cellspacing="3">
           ...
           <tr>
			   ...
			   <td><select style="width:180px;font-size:12px">
           ...
           <tr>
               <td><input id="txtPassword"  placeholder="Zip Code" style="width: 170px; padding-bottom: 8px; padding-left: 8px;font-size:12px"/></td>
           </tr>
		   
           <tr>
               <td style="padding-top:10px">
               <a href="/BetaPageNotFound.aspx" role="button" class="btn btn-primary btn-large" data-toggle="modal-popover" data-placement="bottom" style="width:150px" >Find Trainer</a>
               </td>
           </tr>
       </table>
   </div>
